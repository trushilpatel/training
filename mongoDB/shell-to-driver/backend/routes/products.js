...
router.get('/', (req, res, next) => {
  ...
  MongoClient.connect("mongodb+srv://trushil:1234@cluster0-r7wes.mongodb.net/shop?retryWrites=true&w=majority")
  .then(client => {
...
router.patch('/:id', (req, res, next) => {
  const updatedProduct = {
    name: req.body.name,
    description: req.body.description,
    price: Decimal128(req.body.price), // store this as 128bit decimal in MongoDB
